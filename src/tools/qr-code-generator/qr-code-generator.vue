...
const sizeOption = useQueryParamOrStorage<'small' | 'medium' | 'big'>({ name: 'size', storageName: 'qr-code-gen:sizeOption', defaultValue: 'small' });
...
const text = useQueryParam({ name: 'text', defaultValue: 'https://sharevb-it-tools.vercel.app' });
      ...
      <n-gi span="2">
        ...
        <n-form label-width="130" label-placement="left">
          ...
          <c-buttons-select
            ...
            :label="t('tools.qr-code-generator.texts.label-size')"
            label-position="left"
            label-width="130px"
            label-align="right"
            :options="[
