...
-  fix multiple issues on docker and pipeline after upgrading node24 (f5bc0f8)
...
### Bug fixes
-  release pipeline (d643824)

## Version 2026.07.07-010d1c1
...
### Chores
-  adapt release script for win (010d1c1)

### Documentation
- **changelog**: update changelog for 2026.07.07-153e1ef (3da80fc)
