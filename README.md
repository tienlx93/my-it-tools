...
Please check the [issues](https://github.com/tienlx93/my-it-tools/issues) to see if some feature listed to be implemented.

You have an idea of a tool? Submit a [feature request](https://github.com/tienlx93/my-it-tools/issues/new/choose)!
...
```sh
docker run -d --name my-it-tools --restart unless-stopped -p 8080:80 tienlx93/my-it-tools:latest
```
...
[![contributors](https://contrib.rocks/image?repo=tienlx93/it-tools&refresh=1)](https://github.com/CorentinTh/it-tools/graphs/contributors)
